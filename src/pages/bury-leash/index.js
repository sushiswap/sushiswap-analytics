...
// import {getBuryLeash, getBuryLeashHistories} from "../../core/api/bury-leash";
...
function BuryLeashPage() {
  ...
  const {
    ...
    (previousValue, currentValue) => {
      ...
      const apr =
        (((dayData.volumeUSD * 0.015 * 0.01) / currentValue.xLeashSupply) *
          365) /
  ...
  return (
    <AppShell>
      <Head>
        <title>Bury Leash | LeashaSwap Analytics</title>
      </Head>
