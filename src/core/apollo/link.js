...
export const masterchef = from([
  new RetryLink(),
  new HttpLink({
    uri: `https://gateway.thegraph.com/api/${process.env.THE_GRAPH_API_KEY}/subgraphs/id/5mqK2me3PVLTUhMNESgAqq3SX26eGsMFwo8BLLZwNM4u`,
    shouldBatch: true,
  }),
]);
...
export const exchange = from([
  new RetryLink(),
  new HttpLink({
    uri: `https://gateway.thegraph.com/api/${process.env.THE_GRAPH_API_KEY}/subgraphs/id/D7azkFFPFT5H8i32ApXLr34UQyBfxDAfKoCEK4M832M6`,
    shouldBatch: true,
  }),
]);
